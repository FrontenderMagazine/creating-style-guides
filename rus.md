...
разношерстными, и требовалась масса усилий, что бы найти хоть что то, пригодное 
...
руководство по стилю экономит время разработки, упрощает коммуникацию для 
фронтендеров и позволяет поддерживать целостность дизайна в рамках всего проекта. Это
